...
**合成控制法-----------------------------------
synth 发病率 lngdp ln人口密度 累计确诊 发病率(1922), trunit(7)trperiod(1924) xperiod(1919(1)1923) figure nested keep(scm_synth)
...
forval i=1/18{
qui synth 发病率 lngdp ln人口密度 累计确诊 发病率(1922), xperiod(1919(1)1923) trunit(`i')trperiod(1924) keep(synth_`i', replace)
}             //对所有18个地区分别进行SCM(把18个地区分别作为政策影响组)
...
forval i=1/18 {
  ...
  twoway `lp' || line tr_effect_ date, ///
