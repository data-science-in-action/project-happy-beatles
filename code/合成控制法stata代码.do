...
**合成控制法-----------------------------------
 synth 发病率 lnGDP ln人口密度 累计确诊人数 发病率(1985) 发病率(1991), trunit(29)trperiod(1993) xperiod(1980(1)1992) figure nested keep(scm_synth)
...
**安慰剂检验--------------------
forval i=1/29{
qui synth 发病率 lnGDP ln人口密度 累计确诊人数 发病率(1985) 发病率(1991), xperiod(1980(1)1992) trunit(`i') trperiod(1993) keep(synth_`i', replace)
...
forval i=1/29 {
  ...
  twoway `lp' || line tr_effect_29 date, lcolor(orange) legend(off) xline(1989, lpattern(dash))
}        //画图
